...
public class PackageItemTask implements Tasklet {
    private static final Logger LOGGER = LoggerFactory.getLogger(PackageItemTask.class);
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        LOGGER.info("The {} has been packaged on {}", item, date);
